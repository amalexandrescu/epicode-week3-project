...
window.onload = function () {
  ...
  console.log(generateSingleAnswersArray(obj));
  ...
  let nextButton = document.getElementsByClassName("customNextButton");
...
let numberOfQuestionsSelected = startQuiz();
